    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Legalitas Perusahaan</div>
            </div>
        </div>
        ...
        <div x-data="{ layouts: { grid: true, details: false } }" class="section-body">
            ...
            <div x-show="layouts.grid" class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <a class="text-decoration-none custom-color-inherit" href="{{ route("pelaksanaan.manage", ['divisi' => 'umum', 'menu' => $menu_name, 'sub_menu' => $item->slug_name]) }}">
